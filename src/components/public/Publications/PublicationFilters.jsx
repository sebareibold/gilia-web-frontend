import { CalendarOutlined, TagOutlined, UserOutlined, CloseCircleOutlined } from '@ant-design/icons'
    ...
    <div className="publication-filters-container">
      <div className="publication-filter-group">
        <div className="publication-filter-item">
          <label><CalendarOutlined /> Año</label>
          <input
            type="number"
            name="anio"
            placeholder="Ej: 2024"
        ...
        <div className="publication-filter-item">
          <label><UserOutlined /> Autor</label>
          <input
            type="text"
            name="autores"
      ...
      <button className="publication-filter-clear" onClick={onClear} title="Limpiar filtros">

...
const ProyectoDetail = () => {
  ...
  const descripcionHTML = marked(proyecto.descripcion || proyecto.description || "Sin descripción disponible")
  ...
  const lineaExtension = proyecto.lineaExtension || proyecto.linea_extension || proyecto.linea || proyecto.lineaNombre || "Sin línea"
    ...
    <div className="project-detail-bg">
      <div style={{ maxWidth: "950px", margin: "0 auto", padding: "2rem 0" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <h1 className="project-title-gradient" style={{ marginBottom: "1.2rem" }}>{nombre}</h1>
        </div>
        {/* Project Info */}
        <div className="futuristic-grid futuristic-grid-3" style={{ gap: "2.2rem", marginBottom: "2.5rem" }}>
          {/* Card Inicio */}
          <div className="project-info-card">
            ...
            <div style={{ fontSize: "1rem", color: "#334155", fontWeight: 400 }}>{fechaInicio}</div>
          </div>
          {/* Card Finalización */}
          <div className="project-info-card">
            <div className="project-info-icon">
            ...
            <div style={{ fontSize: "1rem", color: "#334155", fontWeight: 400 }}>{fechaFin}</div>
          </div>
          {/* Card Estado */}
          <div className="project-info-card">
            <div className="project-info-icon">
        ...
        <div style={{ padding: "2.2rem 2rem", marginBottom: 0 }}>
          <div style={{ fontSize: "1.13rem", lineHeight: 1.8, color: "#334155", fontFamily: 'Josefin Sans, Inter, sans-serif', textAlign: "center" }}

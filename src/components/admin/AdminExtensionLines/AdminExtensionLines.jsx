  ...
  const fetchLineas = async () => {
    ...
    try {
      ...
      notification.error({
        ...
        description:
          "No se pudieron cargar las líneas de extensión. Por favor, intente de nuevo más tarde.",
      });
    } finally {
      setLoading(false);
    }
    ...
    >
      <div className="admin-unified-header">
        ...
        <p className="admin-unified-subtitle">
          Gestiona las líneas de extensión del grupo GILIA. Aquí puedes crear,
          editar y organizar las diferentes áreas de extensión.
        </p>
        <button

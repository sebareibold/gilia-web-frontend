...
import { getExtensionLines, getProjects, getPublications, getNews, getTools } from "../../../services";
...
const AdminLineasExtension = () => {
  ...
  const fetchLineas = async () => {
    ...
    try {
      ...
      notification.error({
        ...
        description: "No se pudieron cargar las líneas de extensión.",
      });
    } finally {
      setLoading(false);
    }
  ...
  const handleSave = async () => {
    ...
    try {
      // Simulation
      console.log("Saving extension line:", currentLinea);
        ...
        <>
          <div className="admin-unified-header">
            ...
            <p className="admin-unified-subtitle">
              Gestiona las líneas de extensión del grupo GILIA. 
                    ...
                    <tr key={linea.id}>
                      ...
                      <td data-label="Tipo">
                        <span className="status-badge pending">
                          {linea.type === "Extensión" ? "Line Extension" : "Line Research"}
                        </span>
                      </td>
          ...
          <div className="admin-editor-card-body">
            <div className="editor-form-group">
              ...
              <input 
                ...
                placeholder="Ej: Programa de Extensión..."
              />
            </div>
          </div>
        </div>

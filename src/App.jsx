...
import ResearchLinesContainer from "./components/research_line_Detail/LinesDetailContainer" // Línea de investigación individual
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* Nueva ruta para la página principal de líneas de investigación */}
        <Route path="/lineas-de-investigacion" element={<ResearchLinesContainer />} />
        {/* Ruta existente para una línea específica */}
